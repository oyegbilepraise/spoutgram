          ...
          <div className={styles._xparnts}>
            <div className={styles._xparnts_cvr}>
              ...
              <div className={styles._xpnds_oauths_div}>
                ...
                <div>
                  ...
                  <button className={`${styles.oauths_} ${styles.ggl_oauth}`}>
                    <svg className={styles._0016_auth_svg} xmlns="http://www.w3.org/2000/svg"
                      xmlnsXlink='http://www.w3.org/1999/xlink' viewBox="0 0 48 48">
                      <defs>
                        <path id="a"
                ...
                <div>
                  ...
                  <button className={`${styles.oauths_} ${styles.appl_oauth}`}>
                    <svg className={styles._0016_auth_svg} xmlns="http://www.w3.org/2000/svg" width="2038" height="2500"
              ...
              <span className={styles.xkktndckl}>
                By signing up you agree to our <a href="www.google.com" style={{ color: "#01A8EA" }}>Terms of Use</a> & <a href="www.style.com" style={{ color: "#01A8EA" }}>Cookie Policy</a>.
              </span>
