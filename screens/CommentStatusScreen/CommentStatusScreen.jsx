...
{individualPost?.data?.postImage.length > 0 && <ImageCarousels postImage={individualPost?.data?.postImage} />}
            ...
            <div className={styles._00ftr_pst}>
              <span className={styles._00mn_span}>
                ...
                <span className={styles._00mn_spn_cnt}>{individualPost?.data?.likes.length>0&&individualPost?.data?.likes.length}</span>
              </span>
              <span className={styles._00mn_span}>
                <span>
                  <svg
                ...
                <span className={styles._00mn_spn_cnt}>{comments?.data?.length>0&&comments?.data?.length}</span>
              </span>
              <span className={styles._00mn_span}>
                <span>
                  <svg
                      ...
                      >
                        <div>
                         <Link href={`replies/${comment?._id}`}>
                          ...
                          {comment?.images.length > 0 && <ImageCarousels postImage={comment?.images} />}
                         </Link>
                        </div>
                        ...
                        <div className={styles._00ftr_pst}>
                          <span className={styles._00mn_span}>
                            ...
                            <span className={styles._00mn_spn_cnt}>{comment?.likes.length>0 && comment?.likes.length}</span>
                          </span>
                          <span className={styles._00mn_span}>
                          <Link href={`reply/${comment?._id}`}>
                            ...
                            <span className={styles._00mn_spn_cnt}>{comment?.reply>0 && comment?.reply}</span>
                          </span>
                          <span className={styles._00mn_span}>
                            <span>
                              <svg
