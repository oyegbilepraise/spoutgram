import './forgotPasswordScreen.module.css'
          ...
          <div className={styles._xparnts}>
            <div className={styles._xparnts_cvr}>
              ...
              <div className={styles.xpnd_inpts} style={{ paddingTop: "14px" }}>
                <div>
                  <input type="text" placeholder="Email" className={styles.data_content_pass} />
                  <span style={{ display: "none" }} className="_0013_span">

                    {/* error messages */}
                    <svg className="invalid_svg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
