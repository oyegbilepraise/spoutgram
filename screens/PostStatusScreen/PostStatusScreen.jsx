      ...
      <div class={`${styles.timeline} ${styles._000middlebar}`}>
        <nav style={{paddingLeft: "0px"}} className={styles.___main_nav}>
          <div> 
            ...
            <span style={{textAlign: "center", display: "block", margin: "auto"}} class={styles.not_home_nav_text}>Post</span>
            <span>
              {/*  */}
            </span>
          </div>
        ...
        <div className={`${styles.div} ${styles.data_content}`}>
            ...
            >
              <div>
                <span className={styles._ttl_top}>Hi</span>
              </div>

              <div>
                <span className={styles._ttl_contxt}>Test</span>
              </div>
