...
const LeftSidebar = () => {
  ...
  return (
    ...
    >
      ...
      {/* More */}
      <div onClick={handleShowMore} style={{display: "none"}}>
        <MoreSvg />
...
<span className={styles.span_data_sidebar}>Settings</span>
      ...
      {/* Create */}
      <Link href="/createpost" className={styles.Link} style={{display: "none"}}>
      ...
      {/* Create__button */}
      <Link href="/">
        <button className={styles.create__home__btn} style={{display: ""}}>
