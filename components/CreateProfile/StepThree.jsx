    ...
    <>
      ...
      >
        ...
        {showPopup && (
          <div className={styles.popup__upldmodal}>
            <div
              className={styles.popup__upldmodal__child} >
              ...
              <div className={styles.xyyxyy}>
                ...
                <svg className={styles.photobaby} style={{fill: "rgb(200, 200, 200)"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M11.2703 12.2162L15 6L23 21H2L9 8L11.2703 12.2162ZM12.3897 14.2378L14.9873 19H19.6667L14.8976 10.058L12.3897 14.2378ZM5.34843 19H12.6516L9 12.2185L5.34843 19ZM5.5 8C4.11929 8 3 6.88071 3 5.5C3 4.11929 4.11929 3 5.5 3C6.88071 3 8 4.11929 8 5.5C8 6.88071 6.88071 8 5.5 8Z"></path></svg>
              </div>
            ...
            {imageUrl ? (
              ...
              <div className={styles.image__wrapper__xx}>
                <div style={{textAlign: "center", position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "100%"}}>
                  <svg className={styles.xyxy__svgg__upld} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M4 22C4 17.5817 7.58172 14 12 14C16.4183 14 20 17.5817 20 22H18C18 18.6863 15.3137 16 12 16C8.68629 16 6 18.6863 6 22H4ZM12 13C8.685 13 6 10.315 6 7C6 3.685 8.685 1 12 1C15.315 1 18 3.685 18 7C18 10.315 15.315 13 12 13ZM12 11C14.21 11 16 9.21 16 7C16 4.79 14.21 3 12 3C9.79 3 8 4.79 8 7C8 9.21 9.79 11 12 11Z"></path></svg>
                  <span onClick={() => setShowPopup(true)} className={styles.yxyx__spn__upld}>
                    Tap to Upload
                  </span>
                </div>
              </div>
        ...
        {imageUrl ? (
          <span style={{marginTop: "15px", cursor: "default"}} className={styles._00sxtry}>
            Profile Picture Uploaded!
            <div style={{width: "max-content", position: "absolute", top: "15px", right: "15px"}}>
              <button
              onClick={() => setShowPopup(true)}
              style={{width: "40px", cursor: "pointer", height: "40px", border: "2px solid var(--brand-color)", background: "var(--brand-color)", borderRadius: "50%", padding: "10px", position: "relative"}}
              >
                <svg style={{width: "19px", position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", height: "19px", fill: "white"}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M20 3C20.5523 3 21 3.44772 21 4V5.757L19 7.757V5H5V13.1L9 9.1005L13.328 13.429L12.0012 14.7562L11.995 18.995L16.2414 19.0012L17.571 17.671L18.8995 19H19V16.242L21 14.242V20C21 20.5523 20.5523 21 20 21H4C3.44772 21 3 20.5523 3 20V4C3 3.44772 3.44772 3 4 3H20ZM21.7782 7.80761L23.1924 9.22183L15.4142 17L13.9979 16.9979L14 15.5858L21.7782 7.80761ZM15.5 7C16.3284 7 17 7.67157 17 8.5C17 9.32843 16.3284 10 15.5 10C14.6716 10 14 9.32843 14 8.5C14 7.67157 14.6716 7 15.5 7Z"></path></svg>
              </button>
            </div> 
          </span>
      ...
      <div className={styles.xxdffghy__09l}>
        <div onClick={() => dispatch(nextComponent(2))}>
          <button style={{width: "100%", position: "relative", border: "2px solid var(--brand-color)", background: "white", color: "var(--brand-color)"}}  className={styles.pass_data_bd}>
        ...
        <div>
          <button style={{width: "100%"}}  className={styles.pass_data_bd} type="submit">Create</button>
        </div>
      </div>
