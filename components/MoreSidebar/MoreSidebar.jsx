        ...
        <div className={styles.modal__sidebar_parent}>
          <div className={styles.sidebar__header}>
            <div className={styles.flex__me_too}>
              <div>
                <div className={styles.profile__init__cont}>
                  <span className={styles.blk__proflname}>AV</span>
                </div>
              </div>
            ...
            <div>
              ...
              <span className={styles.xqlsd_usn}>@avary</span>
            </div>
            <div className={styles.flex__sidebar} style={{ marginTop: "12px" }}>
              <div style={{ marginLeft: "5px" }}>
                <h6 className={styles.sideb__mn_p}>
                  <span className={styles.span__mn_p}>70.5K</span>
                  &nbsp;Followers
                </h6>
              </div>
              <div>
                <h6 className={styles.sideb__mn_p}>
                  <span className={styles.span__mn_p}>90.9K</span>
                  &nbsp;Following
                </h6>
              </div>
            </div>
